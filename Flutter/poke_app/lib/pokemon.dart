...
//
//     final pokeHub = pokeHubFromJson(jsonString);

import 'dart:convert';

PokeHub pokeHubFromJson(String str) => PokeHub.fromJson(json.decode(str));

String pokeHubToJson(PokeHub data) => json.encode(data.toJson());
